    ...
    return(
        <View style={styles.container}>
            <TouchableOpacity
                ...
                style={{...styles.button, backgroundColor:gridState?COLORS.light:COLORS.light, borderColor:gridState?COLORS.darkOrange:COLORS.darkGray}}>
                <Icon size={21} source={'grid'} color={gridState?COLORS.darkOrange:COLORS.darkGray}/>
            </TouchableOpacity>
            <TouchableOpacity
                onPress={()=>setGridState(false)}
                style={{...styles.button, backgroundColor:gridState?COLORS.light:COLORS.light, borderColor:gridState?COLORS.darkGray:COLORS.darkOrange}}>
